...
template_image = face_recognition.load_image_file("../../images/anna.jpg")
template_image_face_encoding = face_recognition.face_encodings(template_image)[0]
test_image = face_recognition.load_image_file("../../images/family_02.jpg")
...
for face_encoding in face_encodings:
	...
	for (top, right, bottom, left), name in zip(face_locations, face_names):
		...
		cv2.putText(output, name, (left + 6, bottom - 6), font, 1, (255, 255, 255), 1)
plt.imshow(output)
plt.show()
